...
# author: Justin Jiang
# date: March 16, 2023
# file: graph.py a Python program that implements a graph data structure
...
class Graph:
    ...
    def breadth_first_search(self, s):
        queue = [] #FIFO
        path = [] #list of vertices in the order of discovery

        start = self.vertList[s]#beginning vertex
    ...
    def depth_first_search(self):
        path = []
        #for each vertex in the graph call DFS
